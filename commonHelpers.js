import{i as a,s as u}from"./assets/vendor-5c957d73.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))l(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&l(o)}).observe(document,{childList:!0,subtree:!0});function r(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function l(e){if(e.ep)return;e.ep=!0;const s=r(e);fetch(e.href,s)}})();const p="data:image/png;base64,";function d(t){return`<a class="gallery-link" href="${t.largeImageURL}">
      ...
      </a>`}function m(t){return t.map(d).join("")}const A={iconUrl:p,backgroundColor:"#ef4040",position:"topRight",message:"Sorry, there are no images matching your search query. Please, try again!"},h=document.querySelector(".img-list"),c=document.querySelector(".loading");function f(t){const i=`https://pixabay.com/api/?key=44327397-ede54b0a70b202831c7c411c5&q=${t}&image_type=photo
  &orientation=horizontal&safesearch=true`;fetch(i).then(r=>{if(!r.ok)throw new Error(r.status);return r.json()}).then(r=>{if(r.hits.length===0){a.show(A),c.classList.add("visually-hidden");return}h.innerHTML=m(r.hits),c.classList.add("visually-hidden"),console.log(r.hits)}).catch(r=>{throw new Error(r)})}const n=document.querySelector(".search-form");document.querySelector(".search-btn");const g=document.querySelector(".loading"),y=new u(".img-list a");n.addEventListener("submit",t=>{t.preventDefault(),g.classList.remove("visually-hidden");const i=n.elements.searchText.value.trim();i!==""&&(f(i),y.refresh(),n.reset())});
